...
then
	...
	echo "You can copy your data for $PROGRAM into this directory and"
...
echo "Starting docker container for mussmann/$PROGRAM."
echo ""
...
docker container run -v ${dir}/data/:/app/data --rm -it mussmann/${PROGRAM}:${TAG} /bin/bash
